    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-10 border border-gray-100">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mt-2 font-medium">Log in to your account and support our cause.</p>
        </div>
        ...
        <div className="mt-8 text-center bg-gray-50 p-6 rounded-2xl">
          <p className="text-gray-500 font-medium mb-2">Don't have an account yet?</p>
          <Link to="/user-signup" className="text-primary font-black hover:underline flex items-center justify-center gap-2">
